...
TESS_Folder_ID = os.listdir('C:/Users/Nate Whitsett/OneDrive - Washington University in St. Louis/Desktop/G Type TESS Data')
...
inject_flare_recovered = 0
false_positive = 0
manual_inspect_flare = 0
for G_Stars in TESS_Folder_ID:
    ##Iteration Scheme
    TOI_ID = float(G_Stars[3::])
    a = os.listdir('C:/Users/Nate Whitsett/OneDrive - Washington University in St. Louis/Desktop/G Type TESS Data/' + G_Stars)
    ...
    for folders in a:
        ...
        b, pdcsap_flux, pdcsap_error = Flare.TESS_data_extract('C:/Users/Nate Whitsett/OneDrive - Washington University in St. Louis/Desktop/G Type TESS Data/' + G_Stars + '/' + folders, PDCSAP_ERR=True)
...
print('Detections: ' + str(total_flares_detected))
print('False Detections: '+ str(false_positive))
print('True Flares Recovered: ' + str(inject_flare_recovered))
print('True Flares Missed: ' + str(inject_flare_count - inject_flare_recovered))
print('%-True Flares Recovered: ' + str(inject_flare_recovered/inject_flare_count))
print('False Positive Rate: ' + str(false_positive/test_time))
print('Manually Inspected, Non Injected Flares: ' + str(manual_inspect_flare))
amp_list=[]
FWHM_list = []
result = []
error = []
...
Z = np.transpose(Z)
np.savetxt('C:/Users/Nate Whitsett/OneDrive - Washington University in St. Louis/Desktop/False_Positive Test.csv', Z, delimiter=',')